...
CREATE TABLE user (id INTEGER NOT NULL AUTO_INCREMENT,name VARCHAR(50) NOT NULL,email VARCHAR(50) UNIQUE NOT NULL,password VARCHAR(50) NOT NULL,created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (id));
