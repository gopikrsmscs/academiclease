...
CREATE TABLE room_post (id INTEGER PRIMARY KEY AUTO_INCREMENT,user VARCHAR(50) NOT NULL,university VARCHAR(100) NOT NULL,created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,title TEXT NOT NULL,body TEXT NOT NULL,status VARCHAR(50) NOT NULL);